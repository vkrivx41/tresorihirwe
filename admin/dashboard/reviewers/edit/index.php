        ...
        <div class="content">
            ...
            <div class="form">
                <form action="update.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="content" id="" placeholder="Enter the content">
                    <input type="text" name="sociallink" id="" placeholder="Enter the socialmedia link">
                    <input type="file" name="signaturelink" id="">
                    <input type="file" name="profilelink" id="">
