        ...
        <div class="content">
            ...
            <div class="form">
                <form action="add.php" method="post" enctype="multipart/form-data">
                    ...
                    <input type="text" name="content" id="" placeholder="Enter the content" required>
                    <input type="text" name="sociallink" id="" placeholder="Enter the socialmedia link" required>
                    <label for="">signature image</label>
                    <input type="file" name="signaturelink" id="" required>
                    <label for="">profile image</label>
                    <input type="file" name="profilelink" id="" required>
