...
<head>
    ...
    <link rel="stylesheet" href="./../../styles/view-messages.css">
            ...
            <div class="informations">
                <div class="message">
                    <div class="message-wrapper">
                        <?php 
                            $messageId = $_GET['id'];
                            $messageGetQuery = "SELECT * FROM `messages` WHERE `id`='$messageId'";
                            $messageResults = mysqli_query($conn,$messageGetQuery);
                        
                            if($messageResults){
                                $messageData = mysqli_fetch_assoc($messageResults);
                                $messageSenderName = $messageData['names'];
                                $messageSenderPhone = $messageData['telephone'];
                        ...
                        <div class="bottom">
                            ...
                            <div class="remove">
                                <a href="./../clean/index.php?id=<?=$messageId?>">remove
